        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative">
              <img 
                src="https://www.datocms-assets.com/49357/1657071191-driver_training_action.jpg?auto=format&crop=focalpoint&dpr=1.5&fit=crop&fp-x=0.48&fp-y=0.42&h=640&w=1366" 
          ...
          {LESSON_TYPES.map((type) => (
            ...
            >
              <div className="relative h-48 rounded-t-2xl overflow-hidden">
                <img 
                  src={`https://5.imimg.com/data5/SE/FB/GLADMIN-63483954/learners-car-driving-training-500x500.jpg`}
                  alt={type.title}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl overflow-hidden shadow-sm group hover:shadow-md transition-all">
            <div className="relative h-48">
              <img 
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGiD5ssIANCEtjkn4FPY8XmPCs8PkfKM4fsg&s" 
